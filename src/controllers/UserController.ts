...
export class UserController {
    ...
    getAll() {
        console.log(`--------------------------------------------------`.bgCyan);
        console.log(`${new Date().toISOString()} GET /users`.bgCyan);
    ...
    getById(@Param("id") id: number) {
        console.log(`--------------------------------------------------`.bgCyan);
        console.log(`${new Date().toISOString()} GET /users/${id}`.bgCyan);
    ...
    post(@Body() user: DeepPartial<User>) {
        console.log(`--------------------------------------------------`.bgCyan);
        console.log(`${new Date().toISOString()} POST /users`.bgCyan);
    ...
    put(@Param("id") id: number, @Body({ validate: true }) user: DeepPartial<User>, @CurrentUser() currentUser: DeepPartial<User>) {
        console.log(`--------------------------------------------------`.bgCyan);
        console.log(`${new Date().toISOString()} PUT /users/${id}`.bgCyan);
    ...
    remove(@Param("id") id: number) {
        console.log(`--------------------------------------------------`.bgCyan);
        console.log(`${new Date().toISOString()} DEL /users/${id}`.bgCyan);
